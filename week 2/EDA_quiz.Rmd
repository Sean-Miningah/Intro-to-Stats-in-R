...
(answer)<li> `Misc.Feature`, `Alley`, `Pool.QC` </li> 
...
<li> `Bedroom.AbvGr`
<li> `Overall.Qual`
<li> (answer)`Year.Built`
</ol>

```{r Q4}
# type your code for Question 4 here, and Knit
ames_train %>%
  ggplot(aes(x=price,y=Lot.Area)) +
  geom_point(color="red") +
  scale_y_log10() +
  geom_smooth(method=lm, se=FALSE) +
  labs(x = "Price for Real Estate Unit", y = "Area of the lot",
       title = "Price of lot against the area")

ames_train %>%
  ggplot(aes(x=price,y=Bedroom.AbvGr)) +
  geom_point(color="red") +
  geom_smooth(method=lm, se=FALSE) +
  labs(x = "Price for Real Estate Unit", y = "Average Bedroom Number",
       title = "Price of lot against Average Bedrrom Number")

ames_train %>%
  ggplot(aes(x=price,y=Overall.Qual)) +
  geom_point(color="red") +
  geom_smooth(method=lm, se=FALSE) +
  labs(x = "Price for Real Estate Unit", y = "Overall Quality", 
       title = "Price of lot against the overall quality")

ames_train %>%
  ggplot(aes(x=price,y=Year.Built)) +
  geom_point(color="red") +
  scale_y_log10() +
  scale_x_log10() +
  geom_smooth(method=lm, se=FALSE) +
  labs(x = "Price for Real Estate Unit", y = "Year the Lot was built",
       title = "Price of lot against the Year the property was built")
```
...
<li> (answer)Log-transform `area` but not `price`
<li> Log-transform both `price` and `area`
</ol>

```{r Q5}
# type your code for Question 5 here, and Knit
#It is better to log transform the area because it is not as variable and has high #number of outliers that are skewing the scatterplot.
ames_train %>%
  ggplot(aes(x=price,y=Lot.Area)) +
  geom_point(color="red") +
  scale_y_log10() +
...
<li>(answer) 21 houses do not have a basement.
...
<ol>
<li>(answer) With a p-value near 0.000, we reject the null hypothesis of no difference.
...
<li>(answer) They were built before 1930.
</ol>
...
<ol> 
<li>(answer) `price` is right-skewed.
